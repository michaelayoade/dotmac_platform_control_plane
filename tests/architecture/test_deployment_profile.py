...
Deployment Control a15 now bears a real route and is inventoried, so it is no
...
#: `ModuleManifest` field in the pinned Kernel a100 and is supplied by
#: `dotmac-deployment-control` a15, so it belongs in the same retention proof
