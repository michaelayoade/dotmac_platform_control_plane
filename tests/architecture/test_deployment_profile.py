...
1. **A profile never drops a persistence owner.** The eight module manifests carry
...
def test_every_profile_composes_all_persistence_owners() -> None:
    for profile in PROFILES:
        ...
        assert deployment_control_module in modules, profile.code
        assert billing_module in modules, profile.code
        assert subscriptions_module in modules, profile.code
